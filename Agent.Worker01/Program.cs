...
// Configura Kestrel per ascoltare solo su HTTP porta 5002
...
// Log avvio
logger.LogInformation("=== Agent.Worker01 avviato ===");
logger.LogInformation("Porta: 5002");
...
logger.LogInformation("Agent.Worker01 in ascolto su http://localhost:5002");
logger.LogInformation("Swagger disponibile su http://localhost:5002/swagger");
